...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('cashier')->group(function () {
        ...
        Route::resource('/reservation-balance', ReservationBalanceController::class)->except('store', 'edit', 'create');

        // Delivery
        Route::resource('/delivery', DeliveryController::class)->except('store', 'edit', 'create');
